...
Conforme à l'Algorithme 6 du diaporama :
  - Contrôle de diversité (distance de Hamming adaptée)
  - Insertion conditionnelle selon seuil de diversité
  - Remplacement de la pire solution quand nécessaire
"""
...
class SharedMemoryPool:
    """EMP avec contrôle de diversité."""
    ...
    def insert(self, solution: Solution, iteration: int = 0) -> bool:
        ...
        if self.solutions:
            ...
            if ratio_close > (1 - self.diversity_threshold):
                is_diverse = False
    ...
    def get_statistics(self):
        return {
            ...
            "global_best_fitness": self.get_best_fitness(),
...
class ElitePool(SharedMemoryPool):
    """Pool élitiste pour le mode Ennemis (compétition pure)."""
